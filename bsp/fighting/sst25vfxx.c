...
/**
 * @brief initlization SPI1 SO->PA6, SCK->PA5, MOSI->PA7
 */
static void SPI1_Configuration(void)
{
    ...
    if (rt_sem_init(&spi1_lock, "spi1lock", 1, RT_IPC_FLAG_FIFO) != 0)
    {
        rt_kprintf("init sst25vfxx spi1 lock failed.\r\n");
    }
}
